const semEndRubric = [
    {
      ...
      weight: "35%",
      excellent: ["Includes an engaging introduction, a fully detailed body and an effective conclusion (in which key points are clearly recapped and highlighted)."],
      good: ["Includes an engaging introduction, almost full detailed body, and an effective conclusion (in which majority of key points are recapped and highlighted.)"],
      average: ["Includes an introduction, a detailed body, and a reasonable conclusion (in which some of the key points are not highlighted effectively)."],
      weak: ["Includes an introduction, a less detailed body, and a brief conclusion (which may need additional development)."],
      poor: ["Some content facts seem questionable and is missing an introduction, body and/or conclusion."]
    },
    {
      criteria: "Delivery",
      weight: "20%",
    ...
    },
    {
      ...
      weight: "20%",
      key:"score_qa",
      excellent: ["Confidently demonstrates an excellent interpretation and knowledge of the subject and responds to every question by reviewers."],
      good: ["Demonstrates a very good interpretation and knowledge of the subject and responds to almost all the questions asked."],
      average: ["Demonstrates a good understanding of the subject and responds to almost all the questions asked."],
      weak: ["Demonstrates a fair understanding of questions but answers somewhat vaguely."],
      poor: ["Lacks understanding of the questions, gives incorrect responses or fails to respond at all to questions."]
    }
  ];

  export default semEndRubric;