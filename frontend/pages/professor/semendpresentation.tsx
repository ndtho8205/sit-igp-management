...
const SemEndPresentationPage = () => {
  return (
    <div>
      <h1>Semester End Presentation</h1>
...
SemEndPresentationPage.getLayout = function getLayout(page: ReactElement) {
    return <ProfessorPagesLayout>{page}</ProfessorPagesLayout>;
  };

export default SemEndPresentationPage;